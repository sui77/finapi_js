...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FinApiResTfulServices.UserUpdateParams = factory(root.FinApiResTfulServices.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UserUpdateParams model module.
   * @module model/UserUpdateParams
   * @version v1.92.0
   */

  /**
   * Constructs a new <code>UserUpdateParams</code>.
   * User details
   * @alias module:model/UserUpdateParams
   * @class
   */
  ...
  /**
   * Constructs a <code>UserUpdateParams</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserUpdateParams} obj Optional instance to populate.
   * @return {module:model/UserUpdateParams} The populated <code>UserUpdateParams</code> instance.
   */
