...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FinApiResTfulServices.ClientConfigurationParams = factory(root.FinApiResTfulServices.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ClientConfigurationParams model module.
   * @module model/ClientConfigurationParams
   * @version v1.92.0
   */

  /**
   * Constructs a new <code>ClientConfigurationParams</code>.
   * Client configuration parameters
   * @alias module:model/ClientConfigurationParams
   * @class
   */
  ...
  /**
   * Constructs a <code>ClientConfigurationParams</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClientConfigurationParams} obj Optional instance to populate.
   * @return {module:model/ClientConfigurationParams} The populated <code>ClientConfigurationParams</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isPinStorageAvailableInWebForm'))
        obj.isPinStorageAvailableInWebForm = ApiClient.convertToType(data['isPinStorageAvailableInWebForm'], 'Boolean');
   ...
   * @member {Boolean} isPinStorageAvailableInWebForm
   */
  exports.prototype.isPinStorageAvailableInWebForm = undefined;
