...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FinApiResTfulServices.UserCreateParams = factory(root.FinApiResTfulServices.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UserCreateParams model module.
   * @module model/UserCreateParams
   * @version v1.92.0
   */

  /**
   * Constructs a new <code>UserCreateParams</code>.
   * User details
   * @alias module:model/UserCreateParams
   * @class
   */
  ...
  /**
   * Constructs a <code>UserCreateParams</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserCreateParams} obj Optional instance to populate.
   * @return {module:model/UserCreateParams} The populated <code>UserCreateParams</code> instance.
   */
   ...
   * @default false
   */
  exports.prototype.isAutoUpdateEnabled = false;
