...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FinApiResTfulServices.EditTppCredentialParams = factory(root.FinApiResTfulServices.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EditTppCredentialParams model module.
   * @module model/EditTppCredentialParams
   * @version v1.92.0
   */

  /**
   * Constructs a new <code>EditTppCredentialParams</code>.
   * A container for editing TPP client credentials data
   * @alias module:model/EditTppCredentialParams
   * @class
   */
  ...
  /**
   * Constructs a <code>EditTppCredentialParams</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EditTppCredentialParams} obj Optional instance to populate.
   * @return {module:model/EditTppCredentialParams} The populated <code>EditTppCredentialParams</code> instance.
   */
