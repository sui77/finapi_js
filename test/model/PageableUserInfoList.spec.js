...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageableUserInfoList', function() {
      beforeEach(function() {
        instance = new FinApiResTfulServices.PageableUserInfoList();
      });

      it('should create an instance of PageableUserInfoList', function() {
        // TODO: update the code to test PageableUserInfoList
        expect(instance).to.be.a(FinApiResTfulServices.PageableUserInfoList);
      });
