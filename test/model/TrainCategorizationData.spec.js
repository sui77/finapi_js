...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrainCategorizationData', function() {
      beforeEach(function() {
        instance = new FinApiResTfulServices.TrainCategorizationData();
      });

      it('should create an instance of TrainCategorizationData', function() {
        // TODO: update the code to test TrainCategorizationData
        expect(instance).to.be.a(FinApiResTfulServices.TrainCategorizationData);
      });
