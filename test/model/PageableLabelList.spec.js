...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageableLabelList', function() {
      beforeEach(function() {
        instance = new FinApiResTfulServices.PageableLabelList();
      });

      it('should create an instance of PageableLabelList', function() {
        // TODO: update the code to test PageableLabelList
        expect(instance).to.be.a(FinApiResTfulServices.PageableLabelList);
      });
