...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IbanRuleParams', function() {
      beforeEach(function() {
        instance = new FinApiResTfulServices.IbanRuleParams();
      });

      it('should create an instance of IbanRuleParams', function() {
        // TODO: update the code to test IbanRuleParams
        expect(instance).to.be.a(FinApiResTfulServices.IbanRuleParams);
      });
