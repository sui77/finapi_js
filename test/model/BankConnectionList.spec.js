...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BankConnectionList', function() {
      beforeEach(function() {
        instance = new FinApiResTfulServices.BankConnectionList();
      });

      it('should create an instance of BankConnectionList', function() {
        // TODO: update the code to test BankConnectionList
        expect(instance).to.be.a(FinApiResTfulServices.BankConnectionList);
      });
