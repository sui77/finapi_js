...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BankConsent', function() {
      beforeEach(function() {
        instance = new FinApiResTfulServices.BankConsent();
      });

      it('should create an instance of BankConsent', function() {
        // TODO: update the code to test BankConsent
        expect(instance).to.be.a(FinApiResTfulServices.BankConsent);
      });
