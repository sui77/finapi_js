...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubTransactionParams', function() {
      beforeEach(function() {
        instance = new FinApiResTfulServices.SubTransactionParams();
      });

      it('should create an instance of SubTransactionParams', function() {
        // TODO: update the code to test SubTransactionParams
        expect(instance).to.be.a(FinApiResTfulServices.SubTransactionParams);
      });
