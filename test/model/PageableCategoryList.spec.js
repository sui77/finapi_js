...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageableCategoryList', function() {
      beforeEach(function() {
        instance = new FinApiResTfulServices.PageableCategoryList();
      });

      it('should create an instance of PageableCategoryList', function() {
        // TODO: update the code to test PageableCategoryList
        expect(instance).to.be.a(FinApiResTfulServices.PageableCategoryList);
      });
