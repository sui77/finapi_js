...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CheckCategorizationTransactionData', function() {
      beforeEach(function() {
        instance = new FinApiResTfulServices.CheckCategorizationTransactionData();
      });

      it('should create an instance of CheckCategorizationTransactionData', function() {
        // TODO: update the code to test CheckCategorizationTransactionData
        expect(instance).to.be.a(FinApiResTfulServices.CheckCategorizationTransactionData);
      });
