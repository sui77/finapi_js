...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageableTransactionList', function() {
      beforeEach(function() {
        instance = new FinApiResTfulServices.PageableTransactionList();
      });

      it('should create an instance of PageableTransactionList', function() {
        // TODO: update the code to test PageableTransactionList
        expect(instance).to.be.a(FinApiResTfulServices.PageableTransactionList);
      });
